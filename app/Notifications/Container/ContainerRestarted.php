...
class ContainerRestarted extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject("Code X Hosting: A resource ({$this->name}) has been restarted automatically on {$this->server->name}");
    ...
    {
        $message = "Code X Hosting: A resource ({$this->name}) has been restarted automatically on {$this->server->name}";
        $payload = [
            'message' => $message,
        ];
        if ($this->url) {
            $payload['buttons'] = [
                [
                    [
                        'text' => 'Check Proxy in Code X Hosting',
                        'url' => $this->url,
                    ],
                ],
            ];
