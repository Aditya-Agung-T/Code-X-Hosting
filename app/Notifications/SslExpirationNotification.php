...
class SslExpirationNotification extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject('Code X Hosting: [Action Required] SSL Certificates Renewed - Manual Redeployment Needed');
