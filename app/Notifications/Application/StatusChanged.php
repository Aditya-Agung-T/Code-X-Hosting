...
class StatusChanged extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $fqdn = $this->fqdn;
        $mail->subject("Code X Hosting: {$this->resource_name} has been stopped");
    ...
    public function toDiscord(): DiscordMessage
    {
        return new DiscordMessage(
            ...
            description: '[Open Application in Code X Hosting]('.$this->resource_url.')',
    ...
    {
        $message = 'Code X Hosting: '.$this->resource_name.' has been stopped.';

        return [
            'message' => $message,
            'buttons' => [
                [
                    'text' => 'Open Application in Code X Hosting',
