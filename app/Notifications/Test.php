...
class Test extends Notification implements ShouldQueue
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject('Code X Hosting: Test Email');
    ...
    public function toDiscord(): DiscordMessage
    {
        $message = new DiscordMessage(
            ...
            description: 'This is a test Discord notification from Code X Hosting. :cross_mark: :warning: :information_source:',
    ...
    {
        return [
            'message' => 'Code X Hosting: This is a test Telegram notification from Code X Hosting.',
            'buttons' => [
                [
    ...
    public function toPushover(): PushoverMessage
    {
        return new PushoverMessage(
            ...
            message: 'This is a test Pushover notification from Code X Hosting.',
            buttons: [
                [
                    'text' => 'Go to your dashboard',
                    'url' => base_url(),
    ...
    public function toSlack(): SlackMessage
    {
        return new SlackMessage(
            ...
            description: 'This is a test Slack notification from Code X Hosting.'
        );
    }
    ...
    public function toWebhook(): array
    {
        return [
            'success' => true,
            'message' => 'This is a test webhook notification from Code X Hosting.',
            'event' => 'test',
            'url' => base_url(),
        ];
    }
