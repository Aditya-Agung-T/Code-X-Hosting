...
class BackupSuccess extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject("Code X Hosting: Backup successfully done for {$this->database->name}");
    ...
    {
        $message = "Code X Hosting: Database backup for {$this->name} (db:{$this->database_name}) with frequency of {$this->frequency} was successful.";
