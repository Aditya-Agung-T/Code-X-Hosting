...
class Reachable extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject("Code X Hosting: Server ({$this->server->name}) revived.");
    ...
    {
        return [
            'message' => "Code X Hosting: Server '{$this->server->name}' revived. All automations & integrations are turned on again!",
        ];
    }
