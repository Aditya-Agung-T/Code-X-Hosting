...
class DockerCleanupFailed extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject("Code X Hosting: [ACTION REQUIRED] Docker cleanup job failed on {$this->server->name}");
    ...
    public function toDiscord(): DiscordMessage
    {
        return new DiscordMessage(
            title: ':cross_mark: Code X Hosting: [ACTION REQUIRED] Docker cleanup job failed on '.$this->server->name,
    ...
    {
        return [
            'message' => "Code X Hosting: [ACTION REQUIRED] Docker cleanup job failed on {$this->server->name}!\n\n{$this->message}",
        ];
    }
    ...
    public function toSlack(): SlackMessage
    {
        return new SlackMessage(
            title: 'Code X Hosting: [ACTION REQUIRED] Docker cleanup job failed',
