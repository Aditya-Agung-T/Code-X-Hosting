...
class DockerCleanupSuccess extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject("Code X Hosting: Docker cleanup job succeeded on {$this->server->name}");
    ...
    public function toDiscord(): DiscordMessage
    {
        return new DiscordMessage(
            title: ':white_check_mark: Code X Hosting: Docker cleanup job succeeded on '.$this->server->name,
    ...
    {
        return [
            'message' => "Code X Hosting: Docker cleanup job succeeded on {$this->server->name}!\n\n{$this->message}",
        ];
    }
    ...
    public function toSlack(): SlackMessage
    {
        return new SlackMessage(
            title: 'Code X Hosting: Docker cleanup job succeeded',
