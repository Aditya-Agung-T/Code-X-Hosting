            ...
            <header
                ...
                <div class="flex items-center gap-2 h-full shrink-0 border-r border-neutral-200 dark:border-white/[0.06] transition-[width] duration-200"
                    ...
                    <div class="flex shrink-0 items-baseline gap-1.5 min-w-0">
                        <a href="/" {{ wireNavigate() }} title="Code X Hosting"
                            class="flex items-center hover:opacity-80 transition-opacity">
                            <img x-show="collapsed" x-cloak src="/coolify-logo.svg" alt="Code X Hosting"
                                class="size-5" />
                            <span x-show="!collapsed" class="text-[15px] font-semibold tracking-tight text-black dark:text-white">Code X Hosting</span>
                        </a>
            ...
            <div
                ...
                <div class="flex min-w-0 flex-1 items-center gap-2.5">
                    <a href="/"
                        ...
                        <img src="/coolify-logo.svg" alt="Code X Hosting" class="w-[18px] h-[18px]" />
                    </a>
